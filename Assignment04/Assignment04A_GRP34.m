...
phisum = @(A_1,A_2,phi_1,phi_2) (atan2(sin(A_1*sin(phi_1)+A_2*sin(phi_2))/(A_1*cos(phi_1) + A_2*cos(phi_2)), ...
    cos(A_1*sin(phi_1)+A_2*sin(phi_2))/(A_1*cos(phi_1) + A_2*cos(phi_2))));
